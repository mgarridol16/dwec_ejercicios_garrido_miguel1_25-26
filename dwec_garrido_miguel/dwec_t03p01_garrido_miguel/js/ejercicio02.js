...
Ejemplo: "hola".slice(1,3) → "ol" (cortó la cuerda entre la letra 1 y la 3, sin incluir la 3). LA POSICION DEL FINAL NO LA INCLUYE
...
Ejemplo: "hola".substr(1,2) → "ol" (empieza en la letra 1 y agarra 2 letras). ESTA DEPRECADO NO USAR
